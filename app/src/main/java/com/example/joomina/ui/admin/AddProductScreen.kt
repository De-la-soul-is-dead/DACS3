                    ...
                    ButtonCustom(
                        ...
                        onClickButton = {
                            if (isEmptyString(nameProduct)) {
                                ...
                                productViewModel.addProduct(productTest)
            ...
            Row(
                ...
                Box(
                    modifier = Modifier
                        ...
                        .padding(5.dp)
                        .clickable {
                            productViewModel.deleteData(product.id.toString())
                            productViewModel.getAllProduct {
                                deleteSucces(it)
                            }
                        }
    ...
    Dialog(onDismissRequest = {
        ...
        Card {
            Column(
                ...
                Spacer(modifier = Modifier.height(20.dp))
                ButtonCustom(title = "Change", backGroundColor = YellowMain, onClickButton = {
                    if (isEmptyString(nameProduct)) {
                        errorText = "invalid name of product"
                    } else if (isEmptyString(price.toString())) {
                        errorText = "invalid price of product"
                        ...
                        productViewModel.addProduct(productChange)
                        onDismissRequest()
                    }
                })
            }
